...
public class AStar_Travel extends BestFirstSearch<String, String> {
    ...
    public static class CompareDistances implements Comparator<Node<String,String>> {
        ...
        public int compare(Node<String, String> o1, Node<String, String> o2) {
            if (o1.getPathCost() + problem.getEstimatedDistance(o1.getState()) <
                    o2.getPathCost() + problem.getEstimatedDistance(o2.getState())) {
                return -1;
            } else if (o1.getPathCost() + problem.getEstimatedDistance(o1.getState()) ==
                    o2.getPathCost() + problem.getEstimatedDistance(o2.getState())) {
                return 0;
            } else {
                return 1;
