...
public class AStar_STP_MisplacedTiles extends BestFirstSearch<List<Integer>, String> {
     ...
     * - h(n) is the estimated forward cost to the goal given by the misplaced tiles heuristic
     */
    public static class ComparePathCostMisplacedTiles implements Comparator<Node<List<Integer>,String>>{
        ...
        public int compare(Node<List<Integer>, String> o1, Node<List<Integer>, String> o2) {
            if(o1.getPathCost()+p.mismatchedTiles(o1.getState()) <
                    o2.getPathCost()+p.mismatchedTiles(o2.getState())){
                return -1;
            }else if(o1.getPathCost()+p.mismatchedTiles(o1.getState()) ==
                    o2.getPathCost()+p.mismatchedTiles(o2.getState())){
                return 0;
            }else{
                return 1;
