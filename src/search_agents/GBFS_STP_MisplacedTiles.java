...
public class GBFS_STP_MisplacedTiles extends BestFirstSearch<List<Integer>, String> {
    ...
    /**
     * Comparator class used for Greedy Best-First Search on the Sliding Tile Puzzle.
     * This comparator ranks nodes solely based on the Misplaced Tiles heuristic, which counts
